...
function activate(context) {
    ...
    context.subscriptions.push(vscode.workspace.onDidOpenTextDocument(lint), vscode.workspace.onDidChangeTextDocument(didChangeTextDocument), vscode.workspace.onDidCloseTextDocument(didCloseTextDocument), vscode.workspace.onDidChangeConfiguration(loadCustomConfig));
    // Register CodeActionsProvider
    context.subscriptions.push(vscode.commands.registerCommand(openLinkCommandName, openLink), vscode.languages.registerCodeActionsProvider(markdownLanguageId, {
    ...
    if (rootPath) {
        ...
        context.subscriptions.push(fileSystemWatcher, fileSystemWatcher.onDidCreate(loadCustomConfig), fileSystemWatcher.onDidChange(loadCustomConfig), fileSystemWatcher.onDidDelete(loadCustomConfig));
    }
